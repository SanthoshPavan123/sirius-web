...
- https://github.com/eclipse-sirius/sirius-web/issues/4065[#4065] [diagram] Add dependency to `react-draggable 4.4.6`
...
- https://github.com/eclipse-sirius/sirius-web/issues/4065[#4065] Make outside and edge labels draggable in diagrams
...
- https://github.com/eclipse-sirius/sirius-web/issues/3808[#3808] [trees] Fix interactions with `TreeItemContextMenu` modal
...
- https://github.com/eclipse-sirius/sirius-web/issues/3503[#3503] [trees] Add tree item renaming support to the new architecture
