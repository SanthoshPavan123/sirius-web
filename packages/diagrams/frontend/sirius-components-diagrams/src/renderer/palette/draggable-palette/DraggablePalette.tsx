...
import { useStoreApi, XYPosition } from 'reactflow';
...
import { PaletteSearchField } from './PaletteSearchField';
import { PaletteSearchResult } from './PaletteSearchResult';
import { PaletteToolList } from './PaletteToolList';
